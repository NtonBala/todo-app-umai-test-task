...
/******/ 	__webpack_require__.p = "/todo-app-umai-test-task/";
/******/
/******/
...
/* harmony import */ var _sagaHelpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
...
/* harmony import */ var _scheduler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var zeroBuffer = { isEmpty: _utils__WEBPACK_IMPORTED_MODULE_0__[/* kTrue */ "r"], put: _utils__WEBPACK_IMPORTED_MODULE_0__[/* noop */ "u"], take: _utils__WEBPACK_IMPORTED_MODULE_0__[/* noop */ "u"] };
...
function takeEvery(patternOrChannel, worker) {
  ...
  var yTake = { done: false, value: Object(io["s" /* take */])(patternOrChannel) };
  var yFork = function yFork(ac) {
    return { done: false, value: io["k" /* fork */].apply(undefined, [worker].concat(args, [ac])) };
  };
...
function takeLatest(patternOrChannel, worker) {
  ...
  var yCancel = function yCancel(task) {
    return { done: false, value: Object(io["f" /* cancel */])(task) };
  };
...
function throttle(delayLength, pattern, worker) {
  ...
  var yTake = function yTake() {
    return { done: false, value: Object(io["s" /* take */])(channel) };
  };
  var yFork = function yFork(ac) {
    return { done: false, value: io["k" /* fork */].apply(undefined, [worker].concat(args, [ac])) };
  };
  var yDelay = { done: false, value: Object(io["e" /* call */])(utils["m" /* delay */], delayLength) };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return sagaHelpers_takeEvery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return sagaHelpers_takeLatest; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return sagaHelpers_throttle; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "b", function() { return takeEvery; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "d", function() { return takeLatest; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "f", function() { return throttle; });
...
var _Catcher = _interopRequireDefault(__webpack_require__(71));
...
"use strict";
/* harmony import */ var warning__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
/* harmony import */ var warning__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(warning__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var invariant__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(16), __webpack_require__(46)(module)))
...
var _reduxSaga = _interopRequireDefault(__webpack_require__(80));
...
const routerMiddleware = (0, _reactRouterRedux.routerMiddleware)(history);
...
var MemoryRouter_MemoryRouter = function (_React$Component) {
  ...
  function MemoryRouter() {
    ...
    return _ret = (_temp = (_this = MemoryRouter_possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = Object(es["createMemoryHistory"])(_this.props), _temp), MemoryRouter_possibleConstructorReturn(_this, _ret);
  }
...
var Redirect_Redirect = function (_React$Component) {
  ...
  Redirect.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    var prevTo = Object(es["createLocation"])(prevProps.to);
    var nextTo = Object(es["createLocation"])(this.props.to);

    if (Object(es["locationsAreEqual"])(prevTo, nextTo)) {
...
var StaticRouter_createURL = function createURL(location) {
  return typeof location === "string" ? location : Object(es["createPath"])(location);
};
...
var StaticRouter_StaticRouter = function (_React$Component) {
  ...
  function StaticRouter() {
    ...
    return _ret = (_temp = (_this = StaticRouter_possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.createHref = function (path) {
      ...
      context.action = "PUSH";
      context.location = addBasename(basename, Object(es["createLocation"])(location));
  ...
  StaticRouter.prototype.render = function render() {
    ...
    var history = {
      ...
      action: "POP",
      location: stripBasename(basename, Object(es["createLocation"])(location)),
...
*/
var aa=__webpack_require__(24),ba=__webpack_require__(2),m=__webpack_require__(38),p=__webpack_require__(23),v=__webpack_require__(26),da=__webpack_require__(39),ea=__webpack_require__(40),fa=__webpack_require__(41),ha=__webpack_require__(25);
...
var _rootSaga = __webpack_require__(52);
...
var _watchers = __webpack_require__(53);
...
var _workers = __webpack_require__(55);
...
var _worker = __webpack_require__(56);
...
var _REST = __webpack_require__(57);
...
class Public extends _react.Component {
  render() {
    return _react.default.createElement(_reactRouterDom.Switch, null, _react.default.createElement(_reactRouterDom.Route, {
      ...
      component: _pages.Completed,
      path: _book.book.completed
    }), _react.default.createElement(_reactRouterDom.Route, {
      component: _pages.Trash,
      path: _book.book.trash
    }), _react.default.createElement(_reactRouterDom.Route, {
      component: _pages.CreateEdit,
      path: _book.book.createEdit
...
Object.defineProperty(exports, "CreateEdit", {
  enumerable: true,
  get: function () {
    return _CreateEdit.default;
  }
});

var _Home = _interopRequireDefault(__webpack_require__(70));

var _Completed = _interopRequireDefault(__webpack_require__(77));

var _Trash = _interopRequireDefault(__webpack_require__(78));

var _CreateEdit = _interopRequireDefault(__webpack_require__(79));
...
var _stylesM = _interopRequireDefault(__webpack_require__(72));
...
// Core
// Components
class Completed extends _react.Component {
  render() {
    return _react.default.createElement(_components.Catcher, null, _react.default.createElement(_components.Spinner, null), _react.default.createElement("h1", null, "Completed"));
  }
...
// Core
// Components
class Trash extends _react.Component {
  render() {
    return _react.default.createElement(_components.Catcher, null, _react.default.createElement(_components.Spinner, null), _react.default.createElement("h1", null, "Trash"));
  }
...
// Core
// Components
class CreateEdit extends _react.Component {
  render() {
    return _react.default.createElement(_components.Catcher, null, _react.default.createElement(_components.Spinner, null), _react.default.createElement("h1", null, "Create/edit"));
  }

}

exports.default = CreateEdit;
  ...
  function next(arg, isErr) {
    ...
    try {
      ...
      if (isErr) {
        ...
        **/
        result = utils["q" /* is */].func(iterator.return) ? iterator.return(TASK_CANCEL) : { done: true, value: TASK_CANCEL };
      } else if (arg === CHANNEL_END) {
        // We get CHANNEL_END by taking from a channel that ended using `take` (and not `takem` used to trap End of channels)
        result = utils["q" /* is */].func(iterator.return) ? iterator.return() : { done: true };
      } else {
  ...
  function runEffect(effect, parentEffectId) {
    ...
    **/
    ...
    return (
      ...
      utils["q" /* is */].promise(effect) ? resolvePromise(effect, currCb) : utils["q" /* is */].helper(effect) ? runForkEffect(wrapHelper(effect), effectId, currCb) : utils["q" /* is */].iterator(effect) ? resolveIterator(effect, effectId, name, currCb)
  ...
  function runAllEffect(effects, effectId, cb) {
    ...
    function checkEffectEnd() {
      if (completedCount === keys.length) {
        completed = true;
        cb(utils["q" /* is */].array(effects) ? utils["f" /* array */].from(_extends({}, results, { length: keys.length })) : results);
      }
    }
    ...
    keys.forEach(function (key) {
      var chCbAtKey = function chCbAtKey(res, isErr) {
        ...
        if (isErr) {
          ...
          cb(utils["q" /* is */].array(effects) ? [].slice.call(_extends({}, response, { length: keys.length })) : response);
        }
      };
      chCbAtKey.cancel = utils["u" /* noop */];
      childCbs[key] = chCbAtKey;
...
function runSaga(storeInterface, saga) {
  ...
  var task = proc(iterator, subscribe, Object(utils["A" /* wrapSagaDispatch */])(dispatch), getState, context, { sagaMonitor: sagaMonitor, logger: logger, onError: onError }, effectId, saga.name);
...
var sagaHelpers = __webpack_require__(10);

// EXTERNAL MODULE: ./node_modules/redux-saga/es/effects.js
var es_effects = __webpack_require__(12);
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "eventChannel", function() { return internal_channel["d" /* eventChannel */]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "channel", function() { return internal_channel["b" /* channel */]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "buffers", function() { return buffers["a" /* buffers */]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "takeEvery", function() { return sagaHelpers["a" /* takeEvery */]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "takeLatest", function() { return sagaHelpers["c" /* takeLatest */]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "throttle", function() { return sagaHelpers["e" /* throttle */]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "delay", function() { return utils["m" /* delay */]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "CANCEL", function() { return utils["a" /* CANCEL */]; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "detach", function() { return io["i" /* detach */]; });
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.95cad.js.map